...
filenames = glob.glob(this_repo_path + os.path.sep + '*'+os.path.sep+'*.png')
for filename in filenames:
    Images.append(cv2.imread(filename))
writeAviVideo(videoName = 'Bar Graphs and Histograms Video',frameRate = 1/30,images = Images,openVideo = True)