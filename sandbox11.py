...
for runName in runNames:
    ...
    for eventNumber in eventsOfInterest: # iterates over all runNumber in runsOfInterest (note: runNumber is 0-indexed)
        ...
        theseImages = extractForegroundMask(False,False,True,thisEventImages,ballParkFrame - 10,100,35,0)
    ...
    modifyingTitle = 'thisEvent1 (wo overlay) 150 frames X(no backtracking + 100thresh 35blur)'
